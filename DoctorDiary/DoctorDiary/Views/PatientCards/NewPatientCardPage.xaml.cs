...
namespace DoctorDiary.Views.PatientCards
{
    ...
    {
        private readonly NewPatientCardViewModel _newPatientCardViewModel;

        public NewPatientCardPage()
        {
            InitializeComponent();
            BindingContext = _newPatientCardViewModel = new NewPatientCardViewModel();
        }
        ...
        private void CalendarDatePicker_OnDateSelected(object sender, DateChangedEventArgs e)
        {
            ...
            _newPatientCardViewModel.Birthday.Value = date;
            _newPatientCardViewModel.Birthday.Validate();
            Birthday.Text = date;
        }
        ...
        {
            if (_newPatientCardViewModel.Validate())
            {
                await _newPatientCardViewModel.Save();
            }
            else
            {
